                ...
                $.ajax({
                    ...
                    success: function(data, textStatus, jqXHR) {
                        if (data.status == "SUCCESS") {
                            ...
                            $('#title').html('Valore inserito con successo');
                            $('#subtitle').html('Torna indietro per visualizzare i dati aggiornati');
                    ...
                    error: function(jqXHR, textStatus, errorThrown) {
                        ...
                        $('#subtitle').html('Riprovare ad inviare la misura');
                    },
        ...
        <div id="header"><!-- begin header -->
            ...
            <div style="margin-left: 25px;">
                ...
                <table id="field">
                    <tr align="center">
                        <td>
                            <font size="3px">Simula la ricezione di una nuova rilevazione</font>
                            <br><br>
                            <button id="normal" onclick="normal()">Invia Valore Normale</button>
                            <br>
                            <br>
                            <font size="3px">Simula la ricezione di una rilevazione successiva ad una perdita</font>
                            <br>
                            <br>
                            <button id="alarm" onclick="alarm()">Invia Valore di Allarme</button>
